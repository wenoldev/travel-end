    ...
    <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-50 font-sans flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
          ...
          <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              <div className="flex flex-col gap-6">
                <div className="inline-flex w-fit items-center rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primary dark:bg-primary/20">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  ...
                  <button className="flex h-12 items-center gap-2 rounded-lg border border-slate-200 bg-transparent px-6 text-base font-bold text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800">
              ...
              <div className="relative lg:ml-auto w-full max-w-[600px]">
                <div className="aspect-[4/3] w-full overflow-hidden rounded-2xl bg-slate-100 dark:bg-slate-800 shadow-2xl">
                  <div
                ...
                {/* Floating Badge */}
                <div className="absolute -bottom-6 -left-6 hidden md:flex flex-col gap-1 rounded-xl bg-white p-6 shadow-xl dark:bg-slate-800">
                  <div className="flex items-center gap-2 text-primary">
                    <span className="material-symbols-outlined text-3xl">verified</span>
                    <span className="text-xs font-bold uppercase tracking-wide text-slate-400">Certified</span>
                  </div>
                  <p className="text-2xl font-bold text-slate-900 dark:text-white">#1 Agency</p>
        ...
        <section className="bg-slate-50 dark:bg-slate-800 py-12">
          <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 gap-8 md:grid-cols-4 md:divide-x md:divide-slate-200 dark:md:divide-slate-700">
              <div className="flex flex-col items-center gap-2 text-center md:items-start md:text-left md:pl-8 first:pl-0">
                ...
                <span className="text-sm font-medium text-slate-600 dark:text-slate-400">Happy Travelers</span>
              </div>
              <div className="flex flex-col items-center gap-2 text-center md:items-start md:text-left md:pl-8">
                ...
                <span className="text-sm font-medium text-slate-600 dark:text-slate-400">Destinations</span>
              </div>
              <div className="flex flex-col items-center gap-2 text-center md:items-start md:text-left md:pl-8">
                <span className="text-4xl font-bold text-primary">10</span>
                <span className="text-sm font-medium text-slate-600 dark:text-slate-400">Years Experience</span>
              </div>
              <div className="flex flex-col items-center gap-2 text-center md:items-start md:text-left md:pl-8">
            ...
            <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
              <div className="order-2 lg:order-1 relative">
                <div className="grid grid-cols-2 gap-4">
                  <div className="aspect-[3/4] overflow-hidden rounded-xl bg-slate-200 dark:bg-slate-700">
                    <div
                  ...
                  <div className="aspect-[3/4] overflow-hidden rounded-xl bg-slate-200 dark:bg-slate-700 translate-y-12">
                    <div
                      className="h-full w-full bg-cover bg-center"
              ...
              <div className="order-1 lg:order-2 flex flex-col gap-6">
                <h2 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-4xl">Our Story</h2>
        ...
        <section className="bg-slate-50 dark:bg-slate-800 py-20">
          <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
            <div className="mb-12 text-center md:mb-16">
              <h2 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-4xl">Why Choose Travelend?</h2>
              <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">We go the extra mile to make your journey special.</p>
            </div>
            <div className="grid gap-8 md:grid-cols-3">
              <div className="group rounded-2xl bg-white p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md dark:bg-slate-900">
                ...
                <h3 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">Safety First</h3>
              ...
              <div className="group rounded-2xl bg-white p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md dark:bg-slate-900">
                ...
                <h3 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">Authentic Experiences</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              ...
              <div className="group rounded-2xl bg-white p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md dark:bg-slate-900">
                ...
                <h3 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">Best Price Guarantee</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
