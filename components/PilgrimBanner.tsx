...
export default function PilgrimBanner() {
    return (
                ...
                <div className="relative w-full aspect-[4/5] sm:aspect-auto sm:min-h-[500px] md:aspect-[21/9] rounded-[2rem] sm:rounded-[3rem] overflow-hidden group shadow-2xl">
                    ...
                    <div className="absolute inset-0 flex items-center px-6 sm:px-16 md:px-24">
                        <div className="max-w-2xl flex flex-col gap-4 sm:gap-6">
                            ...
                            >
                                ...
                                <span className="text-white font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-[10px] sm:text-sm">Divine Heritage</span>
                            </motion.div>
                            ...
                            >
                                ...
                                <p className="text-white/80 text-sm sm:text-lg md:text-xl font-medium mt-2 sm:mt-4 max-w-lg">
                                    Explore the sacred shrines and spiritual centers of South India. Experience divine peace and timeless architecture.
                                </p>
                            </motion.div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span className="material-symbols-outlined transition-transform group-hover/btn:translate-x-1 text-xl sm:text-2xl">temple_hindu</span>
                                </Link>
                                <Link
                                    href="/contact?type=pilgrimage"
                                ...
                                >
                                    <span>Plan Spiritual Journey</span>
                                </Link>
                            </motion.div>
                        </div>
                    </div>
                    ...
                    <div className="absolute top-10 right-10 hidden lg:block">
                        <div className="flex flex-col items-end">
                            <span className="text-white/10 text-8xl font-black select-none uppercase tracking-tighter">Divine</span>
                        </div>
                    </div>
                </div>
            </div>
