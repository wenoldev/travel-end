...
export default function RunnerBanner({ imageUrl }: RunnerBannerProps) {
    const displayImage = imageUrl || "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?auto=format&fit=crop&q=80&w=2000"; // Festival image
                ...
                <div className="relative w-full min-h-[600px] sm:aspect-auto sm:min-h-[500px] md:aspect-[21/9] rounded-[2rem] sm:rounded-[3rem] overflow-hidden group shadow-2xl">
                    ...
                    <div className="absolute inset-0 flex items-center px-6 sm:px-16 md:px-24">
                        <div className="max-w-2xl flex flex-col gap-4 sm:gap-6">
                            ...
                            >
                                ...
                                <span className="text-white font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-[10px] sm:text-sm">Festivals & Local Trips</span>
                            </motion.div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span className="material-symbols-outlined transition-transform group-hover/btn:translate-x-1 text-xl sm:text-2xl">celebration</span>
                                </Link>
                                <Link
                                    href="/contact?type=local-trip"
                    ...
                    <div className="absolute top-10 right-10 hidden lg:block">
                        <div className="flex flex-col items-end">
                            <span className="text-white/10 text-8xl font-black select-none uppercase tracking-tighter leading-none">FEST</span>
                        </div>
                    </div>
                </div>
            </div>
