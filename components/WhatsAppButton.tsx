...
export default function WhatsAppButton() {
    ...
    return (
        ...
        >
            ...
            <div className="bg-[#25D366] text-white size-16 rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform relative z-10 border-4 border-white">
                <svg
                    className="size-8"
                    fill="currentColor"
                    viewBox="0 0 24 24"
